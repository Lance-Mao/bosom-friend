			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" data-url="${baseurl}/view/systemBackground/admin/page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
			    	</li>
			    	<li class="layui-nav-item" mobile>
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="${baseurl}/admin/page/user/userInfo.jsp"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
							<%--<dd><a href="javascript:;" data-url="${baseurl}/admin/page/user/changePwd.jsp"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>--%>
							<dd><a href="${baseurl}/view/systemBackground/login/index.jsp"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="${baseurl}/view/systemBackground/admin/page/main.jsp"></iframe>
					</div>
				</div>
			</div>
		</div>
