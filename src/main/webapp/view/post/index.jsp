...
<head>
	...
	<title>11种炫酷CSS3复选框checkbox样式美化效果|DEMO_jQuery之家-自由分享jQuery、html5、css3的插件库</title>
...
<body>
	<div class="htmleaf-container">
		<header class="htmleaf-header">
			<h1>11种炫酷CSS3复选框checkbox样式美化效果 <span>A Bunch of CSS Only Custom Checkboxes</span></h1>
			<div class="htmleaf-links">
				<a class="htmleaf-icon icon-htmleaf-home-outline" href="http://www.htmleaf.com/" title="jQuery之家" target="_blank"><span> jQuery之家</span></a>
				<a class="htmleaf-icon icon-htmleaf-arrow-forward-outline" href="http://www.htmleaf.com/css3/css3donghua/201503211556.html" title="返回下载页" target="_blank"><span> 返回下载页</span></a>
			</div>
		</header>
		<div class="container">
			<div class="holder">
		...
		<div class="related">
		    ...
		    <a href="http://www.htmleaf.com/css3/css3donghua/20141202647.html">
			  <img src="related/1.jpg" width="300" alt="5款纯css3按钮样式"/>
			  <h3>5款纯css3按钮样式</h3>
			</a>
			<a href="http://www.htmleaf.com/css3/css3donghua/20141123576.html">
			  <img src="related/2.jpg" width="300" alt="纯css3各种开关按钮动画特效"/>
			  <h3>纯css3各种开关按钮动画特效</h3>
			</a>
		</div>
	</div>
