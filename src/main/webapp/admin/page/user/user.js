...
layui.config({
    ...
    form.on("submit(changeUser)", function (data) {
        var userName = $(".userNameByEdit").val();
        var sex = $("input[name='sex']:checked").val();
        var phone = $("#phoneByEdit").val();
        var birthday = $("#birthdayByEdit").val();
        var living = $("select[name='province']").find("option:selected").text() + $("select[name='city']").find("option:selected").text() + $("select[name='area']").find("option:selected").text();
