...
<head>
	...
	<link rel="stylesheet" href="${baseurl}/view/systemBackground/admin/css/images.css" media="all" />
</head>
<body class="childrenBody">
	...
	<script type="text/javascript" src="${baseurl}/view/systemBackground/admin/page/img/images.js"></script>
</body>
</html>