...
public interface PersonalityTraitsDao{
	 ...
	 * @return
	 */
    int updatePersonalityTraits(@Param("enti") PersonalityTraits value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyPersonalityTraits(@Param("enti") PersonalityTraits value, @Param("assist") Assist assist);
}